    ...
    return(
        <div className={`modal ${props.loginSignupModalVisibility}`} tabIndex="-1">
                <div className="modal-dialog">
                    ...
                    <form>
                        <div className="mb-3">
                            <label htmlFor="exampleInputEmail1" className="form-label">Email address - Login / Signup</label>
                        ...
                        <button type="button" onClick={props.loginSignupUser} disabled={!props.userMail ? true : false } className="btn btn-primary">Submit</button>
                        </form>
